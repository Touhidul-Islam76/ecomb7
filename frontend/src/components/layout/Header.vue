                    ...
                    <ul class="navbar-nav attr-nav align-items-center">
                        ...
                        <li class="dropdown cart_dropdown"><a class="nav-link cart_trigger" href="#"
                                data-bs-toggle="dropdown"><i class="linearicons-cart"></i><span
                                    class="cart_count">{{ cartStores.count }}</span></a>
                            <div class="cart_box dropdown-menu dropdown-menu-right"
                                style="max-height: 350px; overflow-y: auto;">
                                <ul class="cart_list" v-for="cart in cartStores.allCart" :key="cart.id">
                                    <li>
                                        <a href="#" @click.prevent="remove(cart.id)" class="item_remove"><i
                                                class="ion-close"></i></a>
                                        <a href="#"><img src="/assets/images/cart_thamb1.jpg" alt="cart_thumb1">{{
                                            cart.product.title }}</a>
                                        <span class="cart_quantity"> {{ cart.quantity }} x <span class="cart_amount">
                                                <span class="price_symbole">$</span></span>{{ cart.product.price
                                            }}</span>
                                    </li>
                                ...
                                <div class="cart_footer">
                                    <p class="cart_total"><strong>Subtotal:</strong> <span class="cart_price"> <span
                                                class="price_symbole">$</span></span>{{ (cartStores.subtotal).toFixed(2) }}</p>
                                    <p class="cart_buttons"><router-link to="/carts"
                                            class="btn btn-fill-line rounded-0 view-cart">View Cart</router-link><a
